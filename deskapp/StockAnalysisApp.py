...
def get_stock():
    ...
    if request.method == 'POST':
        stock = request.form['stock'] #Getting user input for stock
        ...
        fig.update_layout(paper_bgcolor="rgb(255,255,255,0)", xaxis_rangeslider_visible=True)

        #Returning plot on same page as inputs
        return render_template('homepage.html', plot=fig.to_html(full_html=False))
